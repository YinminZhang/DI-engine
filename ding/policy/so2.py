...
@POLICY_REGISTRY.register('so2')
class SO2Policy(SACPolicy):
    """
       Overview:
           Policy class of SO2 algorithm. Paper link: https://arxiv.org/pdf/2312.07685
       ...
       Config:
           ...
           10 | ``learn.alpha``     float       1.0            | Entropy regularization          | alpha is initiali-
              ...
              |                                                |                                 | `alpha`, when
              |                                                |                                 | auto_alpha is True
           11 | ``learn.eta``       bool        True           | Parameter of SO2 algorithm     | Defalut to 1.0
    ...
    config = dict(
        ...
        learn=dict(
            ...
            # Perturbed Value Update in original SO2 paper.
            noise=True,
    ...
    def _init_learn(self) -> None:
        """
        Overview:
            Initialize the learn mode of policy, including related attributes and modules. For SO2, in addition \
    ...
    def _forward_learn(self, data: List[Dict[int, Any]]) -> Dict[str, Any]:
        ...
        Arguments:
            - data (:obj:`List[Dict[int, Any]]`): The input data used for policy forward, including a batch of \
                ...
                For SO2, each element in list is a dict containing at least the following keys: ``obs``, ``action``, \
        ...
        .. note::
            For more detailed examples, please refer to our unittest for SO2Policy: \
            ``ding.policy.tests.test_so2``.
        """
        loss_dict = {}
