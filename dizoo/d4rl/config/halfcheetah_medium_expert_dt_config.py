...
halfcheetah_dt_config = dict(
    ...
    policy=dict(
        ...
        n_heads=1,
        dropout_p=0.1,
        log_dir='/home/wangzilin/research/dt/DI-engine/dizoo/d4rl/dt_data/halfcheetah_medium_expert_dt_log',
        model=dict(
            state_dim=17,
            act_dim=6,
            n_blocks=3,
        ...
        nstep=3,
        learn=dict(
            dataset_path='/mnt/lustre/wangzilin/d4rl_data/halfcheetah-medium-expert-v2.pkl',
